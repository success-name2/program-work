...
class LogisticRegression:
    def __init__(self,data,labels,polynomial_degree = 0,sinusoid_degree = 0,normalize_data=False):
        ...
        (data_processed,
         features_mean, 
         features_deviation)  = p(data, polynomial_degree, sinusoid_degree,normalize_data=False)
    ...
    def predict(self,data):
        num_examples = data.shape[0]
        data_processed = p(data, self.polynomial_degree, self.sinusoid_degree,self.normalize_data)[0]
